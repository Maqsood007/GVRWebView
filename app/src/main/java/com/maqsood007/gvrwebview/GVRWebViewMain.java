...
class GVRWebViewMain extends GVRMain {
    private static final String TAG = GVRWebViewMain.class.getSimpleName();
    ...
    private GVRWebViewActivity mActivity;
    ...
    GVRWebViewMain(GVRWebViewActivity activity) {
        ...
        mainThreadHandler = new Handler(mActivity.getMainLooper()) {
            ...
            public void handleMessage(Message msg) {
                ...
                if (msg.what == MOTION_EVENT) {
                    ...
                    gvrWebView.dispatchTouchEvent(motionEvent);
                    gvrWebView.invalidate();
                    motionEvent.recycle();
                }
            }
        };
...
//        createSkybox();
        gvrWebView = mActivity.getFrameLayout();

        DisplayMetrics displayMetrics = mActivity.getResources().getDisplayMetrics();
        int width = displayMetrics.widthPixels;
        int height = displayMetrics.heightPixels;

        webViewSceneObject = new GVRViewSceneObject(gvrContext, gvrWebView,
...
//        webViewSceneObject = new GVRWebViewSceneObject(gvrContext, 6.0f, 6.0f, mActivity.webView);
        ...
        frameWidth = gvrWebView.getWidth();
        frameHeight = gvrWebView.getHeight();
