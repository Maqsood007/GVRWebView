...
public class AndroidWebViewActivity extends GVRActivity implements View.OnTouchListener, View.OnClickListener,
        View.OnFocusChangeListener {


    private static final String TAG = AndroidWebViewActivity.class.getSimpleName();
    private AndroidWebViewMain main;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setFrameLayout();
        main = new AndroidWebViewMain(this);
        setMain(main, "gvr_webview.xml");
    }
    ...
    private void setFrameLayout() {
        ...
        View.inflate(this, R.layout.activity_main_edit, frameLayout);
